...
#
# Steering script for HF enhanced dielectron MC anchored to LHC26 pp apass1
#
...
export ALIEN_JDL_LPMPRODUCTIONTAG=LHC26e9
...
then
        CONFIGNAME="GeneratorHFGapTriggered_Charm_Muon_pp13600GeV_Gap1.ini"
elif [[ $RNDSIG -ge 20 && $RNDSIG -lt 100 ]];
then
        CONFIGNAME="GeneratorHFGapTriggered_BeautyNoForcedDecay_Muon_pp13600GeV_Gap1.ini"
fi
