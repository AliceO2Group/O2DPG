...
# TODO:
# - transform all reco workflows to new format and allow external overwrites
# - find new way of treating tpc distortions arguments
...
for tf in range(1, NTIMEFRAMES + 1):
   ...
   trd_track_sources = dpl_option_from_config(anchorConfig, 'o2-trd-global-tracking', 'track-sources', 'TPC,ITS-TPC')
   ...
   toftracksrcdefault = dpl_option_from_config(anchorConfig, 'o2-tof-matcher-workflow', 'track-sources', 'TPC,ITS-TPC,TPC-TRD,ITS-TPC-TRD')
   ...
   hmp_match_sources = dpl_option_from_config(anchorConfig, 'o2-hmpid-matcher-workflow', 'track-sources', 'ITS-TPC,ITS-TPC-TRD,TPC-TRD')
   ...
   svfinder_sources = dpl_option_from_config(anchorConfig,
                          'o2-primary-vertexing-workflow',
                          'vertex-track-matching-sources',
                          'ITS-TPC,TPC-TRD,ITS-TPC-TRD,TPC-TOF,ITS-TPC-TOF,TPC-TRD-TOF,ITS-TPC-TRD-TOF,MFT-MCH,MCH-MID,ITS,MFT,TPC,TOF,FT0,MID,EMC,PHS,CPV,ZDC,FDD,HMP,FV0,TRD,MCH,CTP')
   ...
   aodinfosources = dpl_option_from_config(anchorConfig, 'o2-aod-producer-workflow', 'info-sources', aod_info_souces_default)
