...
export GEN_TOPO_LIBRARY_FILE=production/standalone-calibration.desc  # Topology description library file to load
export WORKFLOW_DETECTORS=TOF                                        # Optional parameter for the workflow: Detectors to run reconstruction for (comma-separated list)
export WORKFLOW_DETECTORS_QC=TOF                                     # Optional parameter for the workflow: Detectors to run QC for
export WORKFLOW_DETECTORS_CALIB=TOF                                  # Optional parameters for the workflow: Detectors to run calibration for
export WORKFLOW_DETECTORS_RECO=TOF                                   # Optional parameters for the workflow: Detectors to run calibration for
export WORKFLOW_DETECTORS_FLP_PROCESSING=                            # Optional parameters for the workflow: Detectors to run calibration for
export WORKFLOW_PARAMETERS=QC,CALIB                                  # Additional paramters for the workflow
