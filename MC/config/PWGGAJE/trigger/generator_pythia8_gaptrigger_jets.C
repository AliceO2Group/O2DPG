...
// o2-sim-dpl-eventgen --nEvents 10 --generator external --configKeyValues "GeneratorExternal.fileName=generator_pythia8_gaptrigger_jets.C;GeneratorExternal.funcName=getGeneratorPythia8GapGenJE()"
...
public:
  ...
  GeneratorPythia8GapGenJE(int inputTriggerRatio = 5) {
    ...
    TString pathconfigMB = gSystem->ExpandPathName("${O2DPG_ROOT}/MC/config/PWGGAJE/pythia8/generator/pythia8_minbias.cfg");
    ...
    TString pathconfigSignal = gSystem->ExpandPathName("${O2DPG_ROOT}/MC/config/PWGGAJE/pythia8/generator/pythia8_jet.cfg");
...
private:
  ...
  // Handling generators
  Pythia pythiaObjectMinimumBias;
  Pythia pythiaObjectSignal;
...
FairGenerator* getGeneratorPythia8GapGenJE() {
  auto myGen = new o2::eventgen::GeneratorPythia8GapGenJE(5);
  auto seed = (gRandom->TRandom::GetSeed() % 900000000);
