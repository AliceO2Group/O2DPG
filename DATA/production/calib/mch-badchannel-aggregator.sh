...
#WORKFLOW+="o2-qc $ARGS_ALL --config consul://${CONSUL_ENDPOINT}/v1/kv/o2/components/qc/ANY/any/mch-qcmn-epn-digits --local --host epn | "
...
WORKFLOW+="o2-qc $ARGS_ALL --config json://${O2DPG_ROOT}/DATA/production/qc-calib/mch-badchannel.json | "
