...
export GEN_TOPO_WORKFLOW_NAME=fdd-ft0-fv0-ctf-raw                # Name of workflow in topology description library
...
export WORKFLOW_DETECTORS_QC=FDD,FT0,FV0                                     # Optional parameter for the workflow: Detectors to run QC for
...
export OUTPUT_FILE_NAME=$HOME/topologies/ft0-fv0-ctf-raw.xml
