...
class GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ : public o2::eventgen::GeneratorPythia8 {
public:
  ...
  ///  Destructor
  ~GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ() = default;
...
FairGenerator*
  GeneratorBeautyToJpsi_EvtGenMidY_pO(double rapidityMin = -1.5, double rapidityMax = 1.5, bool verbose = false, TString pdgs = "511;521;531;541;5112;5122;5232;5132;5332")
{
  auto gen = new o2::eventgen::GeneratorEvtGen<o2::eventgen::GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ>();
...
FairGenerator*
  GeneratorBeautyToPsiAndJpsi_EvtGenMidY_pO(double rapidityMin = -1.5, double rapidityMax = 1.5, bool verbose = false, TString pdgs = "511;521;531;541;5112;5122;5232;5132;5332")
{
  auto gen = new o2::eventgen::GeneratorEvtGen<o2::eventgen::GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ>();
  gen->setRapidity(rapidityMin, rapidityMax);
  gen->setPDG(5);
...
// Predefined generators:
FairGenerator*
  GeneratorBeautyToJpsi_EvtGenFwdY_pO(double rapidityMin = -4.3, double rapidityMax = -2.3, bool verbose = false, TString pdgs = "511;521;531;541;5112;5122;5232;5132;5332")
{
  auto gen = new o2::eventgen::GeneratorEvtGen<o2::eventgen::GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ>();
  gen->setRapidity(rapidityMin, rapidityMax);
  gen->setPDG(5);
...
FairGenerator*
  GeneratorBeautyToPsiAndJpsi_EvtGenFwdY_pO(double rapidityMin = -4.3, double rapidityMax = -2.3, bool verbose = false, TString pdgs = "511;521;531;541;5112;5122;5232;5132;5332")
{
  auto gen = new o2::eventgen::GeneratorEvtGen<o2::eventgen::GeneratorPythia8NonPromptInjectedpOGapTriggeredDQ>();
  gen->setRapidity(rapidityMin, rapidityMax);
  gen->setPDG(5);
