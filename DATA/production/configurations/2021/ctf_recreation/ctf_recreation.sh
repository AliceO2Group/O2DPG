...
# print workflow
IS_SIMULATED_DATA=0 WORKFLOWMODE=print SYNCMODE=1 TFDELAY=0.1 NTIMEFRAMES=-1 SHMSIZE=16000000000 DDSHMSIZE=32000 TPC_CONVERT_LINKZS_TO_RAW=1 ./run-workflow-on-inputlist.sh TF list.list > workflowconfig.log
# run it
IS_SIMULATED_DATA=0 WORKFLOWMODE=run   SYNCMODE=1 TFDELAY=0.1 NTIMEFRAMES=-1 SHMSIZE=16000000000 DDSHMSIZE=32000 TPC_CONVERT_LINKZS_TO_RAW=1 ./run-workflow-on-inputlist.sh TF list.list 
