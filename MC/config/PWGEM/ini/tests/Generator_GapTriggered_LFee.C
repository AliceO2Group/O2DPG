int External()
{
    ...
    for (int i = 0; i < nEvents; i++) {
        ...
        for (auto& track : *tracks) {
            ...
            if ((pdg == 111) || (pdg == 221) || (pdg == 331) || (pdg == 223) || (pdg == 113) || (pdg == 333) || (pdg == 443) || (pdg == 100443)) {
               if ((y>-1.2) && (y<1.2)) { 
                  nMesons++;
                  Int_t counterel = 0;
                  Int_t counterpos = 0;
...
//    if (nMesonsDiElectronDecay < (8*nEvents)) {
//        std::cerr << "One should have at least 8 mesons that decay into dielectrons per event.\n";
//        return 1;
//    }
//    if (nMesons < nEvents) {
