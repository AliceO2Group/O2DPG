...
export GEN_TOPO_WORKFLOW_NAME=ft0-fv0-ctf-raw                # Name of workflow in topology description library
...
export WORKFLOW_DETECTORS_QC=FT0,FV0                                     # Optional parameter for the workflow: Detectors to run QC for
