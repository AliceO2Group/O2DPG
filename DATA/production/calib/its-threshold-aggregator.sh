...
PROXY_INSPEC="digits:ITS/DIGITS/0;digitsrof:ITS/DIGITSROF/0;calib:ITS/CALIB/0;eos:***/INFORMATION"
...
WORKFLOW+="o2-its-threshold-cali-workflow -b --fittype derivative --output-dir \"/data/calibration\" --meta-output-dir \"/data/epn2eos_tool/epn2eos\" $ARGS_ALL --configKeyValues \"$ARGS_ALL_CONFIG\" | "
