...
parser.add_argument('--disable-strangeness-tracking', action='store_true', default=False, help="Disable strangeness tracking")
...
for tf in range(1, NTIMEFRAMES + 1):
   ...
   if args.disable_strangeness_tracking:
